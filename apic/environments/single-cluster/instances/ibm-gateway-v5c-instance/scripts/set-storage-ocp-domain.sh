...
#GTW_FILE="${SCRIPTDIR}/../instances/ibm-apic-gateway-instance.yaml"
GTW_FILE="${SCRIPTDIR}/../instances/ibm-apic-gateway-v5c-instance.yaml"
#A7S_FILE="${SCRIPTDIR}/../instances/ibm-apic-analytics-instance.yaml"
